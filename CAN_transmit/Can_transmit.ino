...
void setup()
{
  ...
  while (CAN_OK != CAN.begin(CAN_250KBPS))  // baudrate 500kbps
  {
  ...
  void loop()
{
  ...
  cantxValue = map(potValue,0,700,0,255);
  Serial.print("cantxValue: ");
  Serial.println(cantxValue);
  Serial.print("btnValue: ");
  Serial.println(btnValue);
  //Create CanBus data pack 
  unsigned char canMsg[8] = {btnValue, cantxValue, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
